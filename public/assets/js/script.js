...
var JSValidator = /*#__PURE__*/function () {
  function JSValidator(formId) {
    _classCallCheck(this, JSValidator);
    ...
    _defineProperty(this, "msg", {
      ...
      minLength: "Longitud no v\xE1lida. Minimo __minLength__ caracteres.",
      maxLength: "Longitud no v\xE1lida. M\xE1ximo __maxLength__ caracteres.",
      email: "El campo de email no es v\xE1lido",
      integer: "Por favor coloca un n\xFAmero entero",
      alphanumeric: "Solo se permiten letras y n\xFAmeros sin espacios",
      url: "Escribe una URL v\xE1lida. Indica el protocolo http:// o https://"
    });
  ...
  _createClass(JSValidator, [{
    key: "setForm",
    value: function setForm(formId) {
      this.form = document.getElementById(formId);
    }
  }, {
    key: "setInputs",
    value: function setInputs() {
      this.inputs = document.querySelectorAll("#".concat(this.form.id, " .jsValidator"));
    }
  }, {
    key: "setAjax",
    ...
    value: function parseInputs() {
      ...
      this.inputs.forEach(function (input) {
        _this.appendErrorsTag(input);
      });
    }
  }, {
    key: "appendErrorsTag",
    value: function appendErrorsTag(input) {
    ...
    value: function validateForm() {
      ...
      this.form.addEventListener('submit', function (e) {
        ...
        _this2.resetValidation(); // Recorrer cada uno de los inputs
    ...
    value: function validateInput(input) {
      ...
      var validators = input.dataset.validators;
        ...
        validators.forEach(function (validator) {
          /*
          	...
          	Si el validador es length =>  su método de validación sería: _length(input)
          				*/
          _this4["_".concat(validator)](input);
        });
      }
    }
  }, {
    key: "setError",
    value: function setError(input, msg) {
    ...
    key: "setStackError",
    value: function setStackError(input, msg) {
    ...
    key: "setErrorMessage",
    value: function setErrorMessage(input, msg) {
      // Adjuntando el error
    ...
    key: "resetStackError",
    value: function resetStackError() {
      // Pila de errores
      this.errors = [];
    }
  }, {
    key: "resetErrorMessages",
    value: function resetErrorMessages() {
      // Quitar mensajes de error
      var spans = document.querySelectorAll("#".concat(this.form.id, " .error-msg"));
...
JSValidator.prototype.appendExternalErrors = function (errors) {
  ...
  Object.entries(errors).forEach(function (_ref) {
    ...
    var input = document.querySelector("#".concat(_this5.form.id, "  input[name=").concat(key, "]")); // Recuperar el nodo de span de error
...
JSValidator.prototype._length = function (input) {
  ...
  var value = input.value; // Determinar la longitud del input

  var inputLength = value.length; // Definir minLength

  var minLength = input.dataset.min_length !== undefined ? Number(input.dataset.min_length) : this.validators.minLength; // Definir maxLength

  var maxLength = input.dataset.max_length !== undefined ? Number(input.dataset.max_length) : this.validators.maxLength; // Declarar la variable msg

  var msg; // Verificar min length

  if (inputLength < minLength) {
    msg = "Longitud no v\xE1lida. M\xEDnimo ".concat(minLength, " caracteres"), this.setError(input, msg);
  } // Verificar max length


  if (inputLength > maxLength) {
    msg = "Longitud no v\xE1lida. M\xE1ximo ".concat(maxLength, " caracteres"), this.setError(input, msg);
  }
};

JSValidator.prototype._email = function (input) {
  var value = input.value;
  var msg = this.msg.email;
...
JSValidator.prototype._url = function (input) {
  // En primer lugar vamos a recuperar el valor del input
  var value = input.value; // Definir el mensaje de error

  var msg = this.msg.url; // expresión regular para validar url
...
JSValidator.prototype._password_confirmation = function (input) {
  // En primer lugar vamos a recuperar el valor del input
  var value = input.value; // Vamos a crear un arreglo de inputs con el valor password

  var password_inputs = []; // Encontrar un input con el nombre contraseña
  ...
  if (password_inputs.length == 0) {
    ...
    var password_input = password_inputs[0];
...
JSValidator.prototype._checked = function (input) {
  var msg = "Debes marcar esta casilla para continuar"; // expresión regular para validar integer
